...
Route::middleware('role:hr')->group(function () {
    ...
    Route::get('/hr/template-cv/editor',        [HrCvTemplateController::class, 'create'])->name('hr.template-cv.create');
    Route::get('/hr/template-cv/editor/{template}', [HrCvTemplateController::class, 'edit'])->name('hr.template-cv.editor');
    Route::patch('/hr/template-cv/{template}',  [HrCvTemplateController::class, 'update'])->name('hr.template-cv.update');
    Route::patch('/hr/template-cv/{template}/publish', [HrCvTemplateController::class, 'publish'])->name('hr.template-cv.publish');
    Route::patch('/hr/template-cv/{template}/default', [HrCvTemplateController::class, 'setDefault'])->name('hr.template-cv.default');
