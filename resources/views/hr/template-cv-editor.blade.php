...
.blk.sel{border-color:#15803d;border-style:dashed}
.bh{position:absolute;top:4px;right:4px;display:none;gap:4px;z-index:5}
.blk:hover .bh,.blk.sel .bh{display:flex}
.hb{background:#15803d;color:#fff;border:none;border-radius:4px;padding:2px 6px;font-size:10px;cursor:pointer;font-weight:700}
...
function saveDraft(){toast('Draft tersimpan!','#15803d')}
