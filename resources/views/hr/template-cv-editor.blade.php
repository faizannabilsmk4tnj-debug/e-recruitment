...
<div id="bar">
  <a href="/hr/template-cv" style="color:#86efac;font-size:12px;font-weight:600;text-decoration:none;display:flex;align-items:center;gap:4px">
    <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>Back
  </a>
  <div style="flex:1"></div>
  <div contenteditable="true" id="tname" style="color:#fff;font-weight:700;font-size:14px;outline:none;min-width:120px;text-align:center">New Template</div>
  <div style="flex:1"></div>
...
<div id="ribbon">
  <select class="rs2" onchange="fmt('formatBlock',this.value)" style="width:96px"><option value="p">Paragraph</option><option value="h1">Heading 1</option><option value="h2">Heading 2</option><option value="h3">Heading 3</option></select>
  ...
  <div class="rs"></div>
  <button class="rb" onclick="fmt('justifyLeft')" title="Left align"><svg width="13" height="13" fill="currentColor" viewBox="0 0 24 24"><path d="M3 5h18v2H3zm0 4h12v2H3zm0 4h18v2H3zm0 4h12v2H3z"/></svg></button>
  <button class="rb" onclick="fmt('justifyCenter')" title="Center align"><svg width="13" height="13" fill="currentColor" viewBox="0 0 24 24"><path d="M3 5h18v2H3zm3 4h12v2H6zm-3 4h18v2H3zm3 4h12v2H6z"/></svg></button>
  <button class="rb" onclick="fmt('justifyRight')" title="Right align"><svg width="13" height="13" fill="currentColor" viewBox="0 0 24 24"><path d="M3 5h18v2H3zm6 4h12v2H9zm-6 4h18v2H3zm6 4h12v2H9z"/></svg></button>
  <div class="rs"></div>
  ...
  <div class="rs"></div>
  <label class="rb" title="Text Color" style="position:relative;gap:2px;flex-direction:column">
  ...
  <div class="rs"></div>
  <button class="rb" onclick="fmt('removeFormat')" style="font-size:10px;color:#6b7280">&#x2715; Clear Format</button>
  <div style="flex:1"></div>
  <span style="font-size:10px;color:#9ca3af;padding-right:8px">Ctrl+B Bold &middot; Ctrl+I Italic &middot; Ctrl+U Underline</span>
</div>
<div id="sb">
  <div style="font-size:10px;font-weight:800;text-transform:uppercase;color:#6b7280;letter-spacing:.06em;margin-bottom:8px">Add Section</div>
  <button class="ab" onclick="addBlk('header')">&#128100; Profile / Header</button>
  <button class="ab" onclick="addBlk('exp')">&#128188; Work Experience</button>
  <button class="ab" onclick="addBlk('edu')">&#127979; Education</button>
  <button class="ab" onclick="addBlk('skills')">&#128161; Skills</button>
  <button class="ab" onclick="addBlk('contact')">&#128140; Contact</button>
  <button class="ab" onclick="addBlk('summary')">&#128221; Summary</button>
  <button class="ab" onclick="addBlk('div')">&#8213; Divider</button>
</div>
<div id="canvas">
...
document.getElementById('canvas').addEventListener('input', function(e) {
  ...
  if (pg.scrollHeight > 842) {
    ...
    toast('Page limit reached. Excess content rejected.', '#dc2626');
  }
});
...
var acc='#0f3c20'
function addBlk(type){var id='b'+(++blkN),h='';if(type==='header')h='<div style="display:flex;align-items:center;gap:16px;padding:20px 28px"><div style="width:64px;height:64px;border-radius:50%;background:#e5e7eb;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:24px">&#128100;</div><div><div contenteditable="true" style="font-size:20px;font-weight:800;color:#111">Full Name</div><div contenteditable="true" style="font-size:12px;font-weight:600;margin-top:3px;color:'+acc+'">Position / Title</div></div></div>';else if(type==='contact')h='<div style="padding:10px 28px;background:#f9fafb;display:flex;gap:20px;flex-wrap:wrap;font-size:11px"><span>&#9993; <span contenteditable="true">email@example.com</span></span><span>&#128222; <span contenteditable="true">+62 812 0000 0000</span></span><span>&#128205; <span contenteditable="true">Jakarta, Indonesia</span></span></div>';else if(type==='summary')h='<div style="padding:16px 28px"><div contenteditable="true" style="font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:'+acc+';margin-bottom:8px">Profile Summary</div><p contenteditable="true" style="font-size:11px;line-height:1.7;color:#374151;margin:0;border-left:3px solid '+acc+';padding-left:10px">Write your brief profile summary here.</p></div>';else if(type==='exp')h='<div style="padding:16px 28px"><div contenteditable="true" style="font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:'+acc+';margin-bottom:10px">Work Experience</div><div style="display:flex;justify-content:space-between"><div><div contenteditable="true" style="font-size:12px;font-weight:700;color:#111">Job Title</div><div contenteditable="true" style="font-size:11px;color:#6b7280">Company &middot; City</div></div><div contenteditable="true" style="font-size:10px;color:#9ca3af">Jan 2022 &ndash; Present</div></div><ul contenteditable="true" style="margin:8px 0 0 16px;font-size:11px;color:#374151;line-height:1.6"><li>Key responsibilities</li><li>Measurable achievements</li></ul></div>';else if(type==='edu')h='<div style="padding:16px 28px"><div contenteditable="true" style="font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:'+acc+';margin-bottom:10px">Education</div><div style="display:flex;justify-content:space-between"><div><div contenteditable="true" style="font-size:12px;font-weight:700;color:#111">Bachelor of Science in Major</div><div contenteditable="true" style="font-size:11px;color:#6b7280">University Name</div></div><div contenteditable="true" style="font-size:10px;color:#9ca3af">2018 &ndash; 2022</div></div></div>';else if(type==='skills')h='<div style="padding:16px 28px"><div contenteditable="true" style="font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:'+acc+';margin-bottom:8px">Skills</div><div style="display:flex;flex-wrap:wrap;gap:5px" id="'+id+'-tags"><span contenteditable="true" style="background:#f0fdf4;color:#0f3c20;font-size:10px;font-weight:600;padding:2px 9px;border-radius:20px;border:1px solid #bbf7d0">Skill 1</span><span contenteditable="true" style="background:#f0fdf4;color:#0f3c20;font-size:10px;font-weight:600;padding:2px 9px;border-radius:20px;border:1px solid #bbf7d0">Skill 2</span></div></div>';else if(type==='div')h='<div style="padding:4px 0"><hr style="border:none;border-top:1px solid #e5e7eb;margin:0 28px"></div>';else h='<div contenteditable="true" style="padding:16px 28px;font-size:11px;color:#374151">Content...</div>';
var pg=curPage();var oldH=pg.innerHTML;pg.insertAdjacentHTML('beforeend',mkBlk(id,type,h));
if(pg.scrollHeight>842){pg.innerHTML=oldH;toast('Failed: New section exceeds page capacity.','#dc2626');}
...
function delBlk(id){if(confirm('Delete this section?')){document.getElementById(id).remove();}}
function saveDraft(){
  var name=document.getElementById('tname').textContent.trim()||'New Template';
  var html=document.getElementById('canvas').innerHTML;
  if(!TEMPLATE_ID){toast('Save failed: open template from template list page.','#dc2626');return;}
  var fd=new FormData();
  ...
  fetch(UPDATE_URL,{method:'POST',body:fd})
    .then(function(r){toast('Saved!','#0f3c20');})
    .catch(function(){toast('Failed to save!','#dc2626');});
}
function doPreview(){
...
function doPublish(){
  var name=document.getElementById('tname').textContent.trim()||'New Template';
  var html=document.getElementById('canvas').innerHTML;
  if(!TEMPLATE_ID){toast('Publish failed: open template from template list page.','#dc2626');return;}
  var fd=new FormData();
  fd.append('_token',document.querySelector('meta[name="csrf-token"]').content);
  fd.append('_method','PUT');
  fd.append('name',name);
  ...
  fetch(UPDATE_URL,{method:'POST',body:fd})
    .then(function(){toast('Published!','#166534');setTimeout(function(){window.location.href='/hr/template-cv';},1200);})
    .catch(function(){toast('Publish failed!','#dc2626');});
}
...
function applyImport(){
  ...
  if (pg.scrollHeight > 842) {
    ...
    toast('Failed: Template exceeds 1 page (not supported).', '#dc2626');
  } else {
    toast('Import successfully overwritten!', '#15803d');
    save();
  }
  iHTML='';
}
...
function applyDragEvents(){
  document.querySelectorAll('.blk').forEach(function(blk){
    // Add draggable if not exists
    if(!blk.hasAttribute('draggable')) blk.setAttribute('draggable','true');

    // Insert drag handle if not exists in .bh
...
// Load content from DB if exists, or use default blocks
