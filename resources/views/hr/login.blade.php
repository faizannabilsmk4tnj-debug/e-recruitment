    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 px-8 py-10">
        ...
        <div class="space-y-5">
            ...
            <div class="flex items-center justify-center gap-2 py-1">
                ...
                <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Secure HR Portal Session</span>
            </div>
        ...
        <div class="space-y-2 text-center text-sm text-gray-500">
            ...
            <p class="text-xs text-gray-400 pt-1">
                For new HR accounts, please contact the System Administrator.
            </p>
        </div>
    </div>
