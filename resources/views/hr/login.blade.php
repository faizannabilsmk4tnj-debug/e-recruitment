    ...
    <header class="bg-green-900 px-8 py-3.5 flex items-center justify-between shadow-md">
        <div class="flex items-center gap-2.5">
            ...
            <div class="leading-tight">
                <div class="text-xs font-bold text-white leading-none">PT Eco green</div>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="mt-5 flex items-center justify-center gap-4">
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="text-[10px] text-green-400">256-bit SSL Encrypted</span>
                </div>
                <div class="w-px h-3 bg-green-800"></div>
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="text-[10px] text-green-400">Restricted Access</span>
                </div>
            </div>
        </div>
    </main>
