...
<div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
    <h1 class="text-2xl font-bold text-gray-900">Sustainable Careers</h1>
    <p class="text-sm text-gray-500 mt-1">Discover opportunities at PT Ecogreen Oleochemicals — a global leader in sustainable oleochemical manufacturing.</p>
</div>
...
<div class="bg-white rounded-2xl border border-gray-200 p-5 mb-6 shadow-sm">
    <div class="flex items-center gap-3 flex-wrap">
        ...
        <div class="relative flex-1 min-w-[200px] max-w-xs">
            ...
            <input type="text" id="search-job" placeholder="Search position..." class="w-full pl-9 pr-4 py-2 border border-gray-205 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent bg-gray-50">
        </div>
        ...
        <div class="ml-auto flex items-center gap-4">
            ...
            <button id="btn-reset-filter" class="text-sm text-gray-500 hover:text-red-600 border border-gray-200 hover:border-red-300 px-3.5 py-2 rounded-lg transition-colors bg-white">
                Reset
            </button>
        </div>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5" id="job-grid">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 {{ $cardHover }} {{ $cardOpacity }}"
        ...
        <div class="space-y-1.5 text-xs text-gray-500 mb-4">
            ...
            <p class="flex items-center gap-2 text-green-750 font-semibold bg-green-50/50 px-2 py-1 rounded w-fit">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 text-green-600 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect width="20" height="12" x="2" y="6" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/></svg>
...
{{-- Empty state --}}
<div id="no-results" class="hidden text-center py-16 bg-white rounded-2xl border border-gray-200 mt-6">
