...
<section class="bg-white px-16 py-20 flex-1">
    <div class="max-w-lg mx-auto text-center">
        ...
        <!-- Title -->
        <h1 class="text-3xl font-extrabold text-gray-900 mb-4">Application Submitted!</h1>

        <!-- Description -->
        <p class="text-gray-500 leading-relaxed mb-6">Thank you for applying at PT Ecogreen Oleochemicals. We will review your qualifications and provide updates shortly via email or this portal.</p>

        <!-- Status Badge -->
        <div class="inline-flex items-center gap-2 bg-green-50 border border-green-200 px-4 py-2 rounded-full mb-10">
            <span class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
            <span class="text-sm font-semibold text-green-700">Being Processed</span>
        </div>
