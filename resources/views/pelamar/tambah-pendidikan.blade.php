...
<div class="bg-white rounded-xl border border-gray-200 p-8">
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-6">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">School / University Name <span class="text-red-500">*</span></label>
                <input type="text" id="sekolah" placeholder="Example: Bandung Institute of Technology" class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">Education Level <span class="text-red-500">*</span></label>
        ...
        <div class="grid grid-cols-2 gap-6">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">Major / Field of Study</label>
                <input type="text" id="jurusan" placeholder="Example: Mechanical Engineering" class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">Diploma / Certificate Number</label>
                <input type="text" id="no-ijazah" placeholder="Example: 12345/UN6.1/2022" class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-6">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">GPA / Average Grade</label>
                <input type="text" id="ipk" placeholder="Example: 3.75 / 4.00" class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
            </div>
            <div></div>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('btn-simpan').addEventListener('click', function () {
        ...
        if (!sekolah || !tingkat) { alert('School Name and Education Level are required.'); return; }
